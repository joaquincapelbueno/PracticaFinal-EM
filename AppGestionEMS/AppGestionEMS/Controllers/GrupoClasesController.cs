...
namespace AppGestionEMS.Controllers
{
    ...
    public class GrupoClasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,MaximoAlumnos")] GrupoClases grupoClases)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,MaximoAlumnos")] GrupoClases grupoClases)
        {
            if (ModelState.IsValid)
            {
